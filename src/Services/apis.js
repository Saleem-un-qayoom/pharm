...
export const mobileCheckApi = () => {
	return (data, callback) => {
		...
		MAINAPI('POST', `capi/p_mobile_check.php`, {
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 131 ~ return ~ error',
					error
				);
...
export const getHomeApi = () => {
	return (data, callback) => {
		...
		MAINAPI('POST', `capi/p_home_data.php`, {
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 157 ~ return ~ error',
					error
				);
...
export const getCategoryApi = () => {
	return (data, callback) => {
		...
		MAINAPI('POST', `capi/p_cat_list.php`, {
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 183 ~ return ~ error',
					error
				);
...
export const getCategoryResultApi = () => {
	return (data, callback) => {
		...
		MAINAPI('POST', `capi/p_list_product_by_cat_and_pincode.php`, {
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 210 ~ return ~ error',
					error
				);
...
export const uploadPrescriptionApi = () => {
	return (data, callback) => {
		...
		MAINAPI('POST', `capi/p_upload_prescription.php`, data, true)
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 258 ~ return ~ error',
					error
				);
...
export const getNotificationApi = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_notification_list.php`, data)
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 297 ~ return ~ error',
					error
				);
				if (callback) callback(error.response);
			});
...
export const getMyOrderApi = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_order_history.php`, data)
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 301 ~ return ~ error',
					error
				);
...
export const getMyOrderDetailsApi = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_order_details.php`, data)
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 319 ~ return ~ error',
					error
				);
...
export const updateUserDetails = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_profile.php`, data)
			.then(response => {
				if (response) {
					console.log(
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 340 ~ return ~ error',
					error
				);
...
export const getSearchApi = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_product_search.php`, data)
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 361 ~ return ~ error',
					error
				);
...
export const getSignUpApi = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_reg_user.php`, data)
			.then(response => {
				if (response) {
					console.log(
						'🚀 ~ file: apis.js ~ line 395~ .then ~ response',
						response
					);
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 403 ~ return ~ error',
					error
				);
...
export const forgetPasswordApi = () => {
	return (data, callback) => {
		MAINAPI('POST', `capi/p_forget_password.php`, data)
			.then(response => {
				if (response) {
					console.log(
						'🚀 ~ file: apis.js ~ line 454 ~ return ~ response',
						response
					);
					if (callback) callback(response);
				}
			...
			.catch(error => {
				console.log(
					'🚀 ~ file: apis.js ~ line 462 ~ return ~ error',
					error
				);
				if (callback) callback(error.response);
			});
