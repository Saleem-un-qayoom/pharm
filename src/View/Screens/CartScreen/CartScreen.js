              ...
              {cart.map((item) => (
                <div>
                  <div className="px-2 mb-4 mt-2">
                    <div>
                      <span className="inline-block leading-3	font8 font-normal px-2 py-1 background-primary rounded-r-full rounded-b-full">
                    ...
                    <div className="flex h-18">
                      <div className="bg-white w-20 h-full flex justify-center items-center">
                        <img
